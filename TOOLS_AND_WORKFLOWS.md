...
**Note:** The Streamlit dashboard has been retired. The automated Live_Trackers pipeline is paused to reduce API costs. Deprecated files (Streamlit source, Scrapy spider, old workflows) are in `Archive/`.

---

### 2. Live_Trackers (v2.4) — **Private Repository** *(Pipeline Paused)*

**Purpose:** Unified real-time intelligence pipeline. The dashboard this powered has been taken down.

**Status:** The automated twice-daily pipeline has been paused to reduce API costs. The dashboard has been taken down.
...
### 7. UVB-76-Structured-Signal-Analysis
...
### 9. AI-Manipulation-OSINT-Case-Study
...
### 11. Arkansas-Law-Changes-and-AI
...
### 17. Retaliation-and-Solutions_States-Taking-the-Initiative
...
**BYOK / open source:** Available at [Friction_Breaker](https://github.com/Leerrooy95/Friction_Breaker). Runs locally on Python ≥ 3.10 with a user-supplied Anthropic API key. No account needed.
...
**Deployment:** Local install (localhost:5000) or any server running Python ≥ 3.10.
...
**Support:** austin@regulatedfriction.me
...
| **AI/LLM APIs** | Anthropic Claude (Sonnet, Opus 4.6), Brave Search API, Meta Llama Scout 17B, Google Gemini |
